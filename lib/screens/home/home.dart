...
class HomePage extends StatelessWidget {
  ...
  Future<void> getCount(int dorm) async {
    int count = 0;
    count = await MainModel.getMachineCount(dorm.toString(), floor.toString(), 'setakkiCount');
    this.setakkiCount = count;
    count = await MainModel.getMachineCount(dorm.toString(), floor.toString(), 'gunjokiCount');
                      ...
                      child: ListView.separated(
                        scrollDirection: Axis.horizontal,
                          ...
                          itemBuilder: (BuildContext context, int index){
                            return Row(
                              children: [
                                BuildSetakki(dorm, floor, index+1 ,'${index+1}setakki'),
